...
private:
    ...
    ObjectEntry entry_x4sub0 = ObjectEntry(&data.x4, 1, 4);
    ObjectEntryBase *entries_x4[1] = {&entry_x4sub0};
    ObjectEntry entry_x5sub0 = ObjectEntry(&data.x5, 1, 1);
    ObjectEntryBase *entries_x5[1] = {&entry_x5sub0};
    ObjectEntry entry_x6sub0 = ObjectEntry(&data.x6, 1, 2);
    ObjectEntryBase *entries_x6[1] = {&entry_x6sub0};
    ObjectEntry entry_x7sub0 = ObjectEntry(&data.x7, 1, 4);
    ObjectEntryBase *entries_x7[1] = {&entry_x7sub0};
    ObjectEntry entry_x1000sub0 = ObjectEntry(&data.x1000, 1, 4);
    ObjectEntryBase *entries_x1000[1] = {&entry_x1000sub0};
    ObjectEntry entry_x1001sub0 = ObjectEntry(&data.x1001, 5, 1);
    ObjectEntryBase *entries_x1001[1] = {&entry_x1001sub0};
    ObjectEntry entry_x1003sub0 = ObjectEntry(&data.x1003sub0, 3, 1);
    ObjectEntry entry_x1003sub1 = ObjectEntry(&data.x1003[0], 1, 4);
    ObjectEntry entry_x1003sub2 = ObjectEntry(&data.x1003[1], 1, 4);
    ObjectEntry entry_x1003sub3 = ObjectEntry(&data.x1003[2], 1, 4);
    ObjectEntry entry_x1003sub4 = ObjectEntry(&data.x1003[3], 1, 4);
    ObjectEntry entry_x1003sub5 = ObjectEntry(&data.x1003[4], 1, 4);
    ObjectEntry entry_x1003sub6 = ObjectEntry(&data.x1003[5], 1, 4);
    ObjectEntry entry_x1003sub7 = ObjectEntry(&data.x1003[6], 1, 4);
    ObjectEntry entry_x1003sub8 = ObjectEntry(&data.x1003[7], 1, 4);
    ...
    ObjectEntry entry_x1005sub0 = ObjectEntry(&data.x1005, 3, 4);
    ObjectEntryBase *entries_x1005[1] = {&entry_x1005sub0};
    ObjectEntry entry_x1006sub0 = ObjectEntry(&data.x1006, 3, 4);
    ObjectEntryBase *entries_x1006[1] = {&entry_x1006sub0};
    ObjectEntry entry_x1007sub0 = ObjectEntry(&data.x1007, 3, 4);
    ObjectEntryBase *entries_x1007[1] = {&entry_x1007sub0};
    ObjectEntry entry_x1008sub0 = ObjectEntry(&data.x1008, 1, 17);
    ObjectEntryBase *entries_x1008[1] = {&entry_x1008sub0};
    ObjectEntry entry_x1009sub0 = ObjectEntry(&data.x1009, 1, 12);
    ObjectEntryBase *entries_x1009[1] = {&entry_x1009sub0};
    ObjectEntry entry_x100Asub0 = ObjectEntry(&data.x100A, 1, 18);
    ObjectEntryBase *entries_x100A[1] = {&entry_x100Asub0};
    ObjectEntry entry_x100Csub0 = ObjectEntry(&data.x100C, 3, 2);
    ObjectEntryBase *entries_x100C[1] = {&entry_x100Csub0};
    ObjectEntry entry_x100Dsub0 = ObjectEntry(&data.x100D, 3, 1);
    ObjectEntryBase *entries_x100D[1] = {&entry_x100Dsub0};
    ObjectEntry entry_x1010sub0 = ObjectEntry(&data.x1010sub0, 1, 1);
    ObjectEntry entry_x1010sub1 = ObjectEntry(&data.x1010[0], 3, 4);
    ObjectEntry entry_x1010sub2 = ObjectEntry(&data.x1010[1], 3, 4);
    ObjectEntry entry_x1010sub3 = ObjectEntry(&data.x1010[2], 3, 4);
    ObjectEntry entry_x1010sub4 = ObjectEntry(&data.x1010[3], 3, 4);
    ObjectEntry entry_x1010sub5 = ObjectEntry(&data.x1010[4], 3, 4);
    ObjectEntry entry_x1010sub6 = ObjectEntry(&data.x1010[5], 3, 4);
    ObjectEntry entry_x1010sub7 = ObjectEntry(&data.x1010[6], 3, 4);
    ObjectEntry entry_x1010sub8 = ObjectEntry(&data.x1010[7], 3, 4);
    ObjectEntry entry_x1010sub9 = ObjectEntry(&data.x1010[8], 3, 4);
    ObjectEntry entry_x1010sub10 = ObjectEntry(&data.x1010[9], 3, 4);
    ObjectEntry entry_x1010sub11 = ObjectEntry(&data.x1010[10], 3, 4);
    ObjectEntry entry_x1010sub12 = ObjectEntry(&data.x1010[11], 3, 4);
    ObjectEntry entry_x1010sub13 = ObjectEntry(&data.x1010[12], 3, 4);
    ...
    ObjectEntry entry_x1011sub0 = ObjectEntry(&data.x1011sub0, 1, 1);
    ObjectEntry entry_x1011sub1 = ObjectEntry(&data.x1011[0], 3, 4);
    ObjectEntry entry_x1011sub2 = ObjectEntry(&data.x1011[1], 3, 4);
    ObjectEntry entry_x1011sub3 = ObjectEntry(&data.x1011[2], 3, 4);
    ObjectEntry entry_x1011sub4 = ObjectEntry(&data.x1011[3], 3, 4);
    ObjectEntry entry_x1011sub5 = ObjectEntry(&data.x1011[4], 3, 4);
    ObjectEntry entry_x1011sub6 = ObjectEntry(&data.x1011[5], 3, 4);
    ObjectEntry entry_x1011sub7 = ObjectEntry(&data.x1011[6], 3, 4);
    ObjectEntry entry_x1011sub8 = ObjectEntry(&data.x1011[7], 3, 4);
    ObjectEntry entry_x1011sub9 = ObjectEntry(&data.x1011[8], 3, 4);
    ObjectEntry entry_x1011sub10 = ObjectEntry(&data.x1011[9], 3, 4);
    ObjectEntry entry_x1011sub11 = ObjectEntry(&data.x1011[10], 3, 4);
    ObjectEntry entry_x1011sub12 = ObjectEntry(&data.x1011[11], 3, 4);
    ObjectEntry entry_x1011sub13 = ObjectEntry(&data.x1011[12], 3, 4);
    ...
    ObjectEntry entry_x1014sub0 = ObjectEntry(&data.x1014, 3, 4);
    ObjectEntryBase *entries_x1014[1] = {&entry_x1014sub0};
    ObjectEntry entry_x1016sub0 = ObjectEntry(&data.x1016sub0, 1, 1);
    ObjectEntry entry_x1016sub1 = ObjectEntry(&data.x1016[0], 3, 4);
    ObjectEntryBase *entries_x1016[2] = {&entry_x1016sub0, &entry_x1016sub1};
    ObjectEntry entry_x1017sub0 = ObjectEntry(&data.x1017, 3, 2);
    ObjectEntryBase *entries_x1017[1] = {&entry_x1017sub0};
    ObjectEntry entry_x1018sub0 = ObjectEntry(&data.x1018.sub0, 1, 1);
    ObjectEntry entry_x1018sub1 = ObjectEntry(&data.x1018.sub1, 1, 4);
    ObjectEntry entry_x1018sub2 = ObjectEntry(&data.x1018.sub2, 1, 4);
    ObjectEntry entry_x1018sub3 = ObjectEntry(&data.x1018.sub3, 1, 4);
    ObjectEntry entry_x1018sub4 = ObjectEntry(&data.x1018.sub4, 1, 4);
    ObjectEntryBase *entries_x1018[5] = {&entry_x1018sub0, &entry_x1018sub1, &entry_x1018sub2, &entry_x1018sub3, &entry_x1018sub4};
    ObjectEntry entry_x1019sub0 = ObjectEntry(&data.x1019, 3, 1);
    ObjectEntryBase *entries_x1019[1] = {&entry_x1019sub0};
    ObjectEntry entry_x1020sub0 = ObjectEntry(&data.x1020sub0, 1, 1);
    ObjectEntry entry_x1020sub1 = ObjectEntry(&data.x1020[0], 3, 4);
    ObjectEntry entry_x1020sub2 = ObjectEntry(&data.x1020[1], 3, 4);
    ObjectEntryBase *entries_x1020[3] = {&entry_x1020sub0, &entry_x1020sub1, &entry_x1020sub2};
    ObjectEntry entry_x1029sub0 = ObjectEntry(&data.x1029sub0, 1, 1);
    ObjectEntry entry_x1029sub1 = ObjectEntry(&data.x1029[0], 3, 1);
    ObjectEntry entry_x1029sub2 = ObjectEntry(&data.x1029[1], 3, 1);
    ObjectEntryBase *entries_x1029[3] = {&entry_x1029sub0, &entry_x1029sub1, &entry_x1029sub2};
    ObjectEntry entry_x1400sub0 = ObjectEntry(&data.x1400.sub0, 1, 1);
    ObjectEntry entry_x1400sub1 = ObjectEntry(&data.x1400.sub1, 3, 4);
    ObjectEntry entry_x1400sub2 = ObjectEntry(&data.x1400.sub2, 3, 1);
    ObjectEntry entry_x1400sub3 = ObjectEntry(&data.x1400.sub3, 3, 2);
    ObjectEntry entry_x1400sub4 = ObjectEntry(&data.x1400.sub4, 3, 1);
    ObjectEntry entry_x1400sub5 = ObjectEntry(&data.x1400.sub5, 3, 2);
    ...
    ObjectEntry entry_x1401sub0 = ObjectEntry(&data.x1401.sub0, 1, 1);
    ObjectEntry entry_x1401sub1 = ObjectEntry(&data.x1401.sub1, 3, 4);
    ObjectEntry entry_x1401sub2 = ObjectEntry(&data.x1401.sub2, 3, 1);
    ObjectEntry entry_x1401sub3 = ObjectEntry(&data.x1401.sub3, 3, 2);
    ObjectEntry entry_x1401sub4 = ObjectEntry(&data.x1401.sub4, 3, 1);
    ObjectEntry entry_x1401sub5 = ObjectEntry(&data.x1401.sub5, 3, 2);
    ...
    ObjectEntry entry_x1402sub0 = ObjectEntry(&data.x1402.sub0, 1, 1);
    ObjectEntry entry_x1402sub1 = ObjectEntry(&data.x1402.sub1, 3, 4);
    ObjectEntry entry_x1402sub2 = ObjectEntry(&data.x1402.sub2, 3, 1);
    ObjectEntry entry_x1402sub3 = ObjectEntry(&data.x1402.sub3, 3, 2);
    ObjectEntry entry_x1402sub4 = ObjectEntry(&data.x1402.sub4, 3, 1);
    ObjectEntry entry_x1402sub5 = ObjectEntry(&data.x1402.sub5, 3, 2);
    ...
    ObjectEntry entry_x1403sub0 = ObjectEntry(&data.x1403.sub0, 1, 1);
    ObjectEntry entry_x1403sub1 = ObjectEntry(&data.x1403.sub1, 3, 4);
    ObjectEntry entry_x1403sub2 = ObjectEntry(&data.x1403.sub2, 3, 1);
    ObjectEntry entry_x1403sub3 = ObjectEntry(&data.x1403.sub3, 3, 2);
    ObjectEntry entry_x1403sub4 = ObjectEntry(&data.x1403.sub4, 3, 1);
    ObjectEntry entry_x1403sub5 = ObjectEntry(&data.x1403.sub5, 3, 2);
    ...
    ObjectEntry entry_x1600sub0 = ObjectEntry(&data.x1600.sub0, 3, 1);
    ObjectEntry entry_x1600sub1 = ObjectEntry(&data.x1600.sub1, 3, 4);
    ObjectEntry entry_x1600sub2 = ObjectEntry(&data.x1600.sub2, 3, 4);
    ObjectEntry entry_x1600sub3 = ObjectEntry(&data.x1600.sub3, 3, 4);
    ObjectEntry entry_x1600sub4 = ObjectEntry(&data.x1600.sub4, 3, 4);
    ObjectEntry entry_x1600sub5 = ObjectEntry(&data.x1600.sub5, 3, 4);
    ObjectEntry entry_x1600sub6 = ObjectEntry(&data.x1600.sub6, 3, 4);
    ObjectEntry entry_x1600sub7 = ObjectEntry(&data.x1600.sub7, 3, 4);
    ObjectEntry entry_x1600sub8 = ObjectEntry(&data.x1600.sub8, 3, 4);
    ...
    ObjectEntry entry_x1601sub0 = ObjectEntry(&data.x1601.sub0, 3, 1);
    ObjectEntry entry_x1601sub1 = ObjectEntry(&data.x1601.sub1, 3, 4);
    ObjectEntry entry_x1601sub2 = ObjectEntry(&data.x1601.sub2, 3, 4);
    ObjectEntry entry_x1601sub3 = ObjectEntry(&data.x1601.sub3, 3, 4);
    ObjectEntry entry_x1601sub4 = ObjectEntry(&data.x1601.sub4, 3, 4);
    ObjectEntry entry_x1601sub5 = ObjectEntry(&data.x1601.sub5, 3, 4);
    ObjectEntry entry_x1601sub6 = ObjectEntry(&data.x1601.sub6, 3, 4);
    ObjectEntry entry_x1601sub7 = ObjectEntry(&data.x1601.sub7, 3, 4);
    ObjectEntry entry_x1601sub8 = ObjectEntry(&data.x1601.sub8, 3, 4);
    ...
    ObjectEntry entry_x1602sub0 = ObjectEntry(&data.x1602.sub0, 3, 1);
    ObjectEntry entry_x1602sub1 = ObjectEntry(&data.x1602.sub1, 3, 4);
    ObjectEntry entry_x1602sub2 = ObjectEntry(&data.x1602.sub2, 3, 4);
    ObjectEntry entry_x1602sub3 = ObjectEntry(&data.x1602.sub3, 3, 4);
    ObjectEntry entry_x1602sub4 = ObjectEntry(&data.x1602.sub4, 3, 4);
    ObjectEntry entry_x1602sub5 = ObjectEntry(&data.x1602.sub5, 3, 4);
    ObjectEntry entry_x1602sub6 = ObjectEntry(&data.x1602.sub6, 3, 4);
    ObjectEntry entry_x1602sub7 = ObjectEntry(&data.x1602.sub7, 3, 4);
    ObjectEntry entry_x1602sub8 = ObjectEntry(&data.x1602.sub8, 3, 4);
    ...
    ObjectEntry entry_x1603sub0 = ObjectEntry(&data.x1603.sub0, 3, 1);
    ObjectEntry entry_x1603sub1 = ObjectEntry(&data.x1603.sub1, 3, 4);
    ObjectEntry entry_x1603sub2 = ObjectEntry(&data.x1603.sub2, 3, 4);
    ObjectEntry entry_x1603sub3 = ObjectEntry(&data.x1603.sub3, 3, 4);
    ObjectEntry entry_x1603sub4 = ObjectEntry(&data.x1603.sub4, 3, 4);
    ObjectEntry entry_x1603sub5 = ObjectEntry(&data.x1603.sub5, 3, 4);
    ObjectEntry entry_x1603sub6 = ObjectEntry(&data.x1603.sub6, 3, 4);
    ObjectEntry entry_x1603sub7 = ObjectEntry(&data.x1603.sub7, 3, 4);
    ObjectEntry entry_x1603sub8 = ObjectEntry(&data.x1603.sub8, 3, 4);
    ...
    ObjectEntry entry_x1800sub0 = ObjectEntry(&data.x1800.sub0, 1, 1);
    ObjectEntry entry_x1800sub1 = ObjectEntry(&data.x1800.sub1, 3, 4);
    ObjectEntry entry_x1800sub2 = ObjectEntry(&data.x1800.sub2, 3, 1);
    ObjectEntry entry_x1800sub3 = ObjectEntry(&data.x1800.sub3, 3, 2);
    ObjectEntry entry_x1800sub4 = ObjectEntry(&data.x1800.sub4, 3, 1);
    ObjectEntry entry_x1800sub5 = ObjectEntry(&data.x1800.sub5, 3, 2);
    ObjectEntry entry_x1800sub6 = ObjectEntry(&data.x1800.sub6, 3, 1);
    ...
    ObjectEntry entry_x1801sub0 = ObjectEntry(&data.x1801.sub0, 1, 1);
    ObjectEntry entry_x1801sub1 = ObjectEntry(&data.x1801.sub1, 3, 4);
    ObjectEntry entry_x1801sub2 = ObjectEntry(&data.x1801.sub2, 3, 1);
    ObjectEntry entry_x1801sub3 = ObjectEntry(&data.x1801.sub3, 3, 2);
    ObjectEntry entry_x1801sub4 = ObjectEntry(&data.x1801.sub4, 3, 1);
    ObjectEntry entry_x1801sub5 = ObjectEntry(&data.x1801.sub5, 3, 2);
    ObjectEntry entry_x1801sub6 = ObjectEntry(&data.x1801.sub6, 3, 1);
    ...
    ObjectEntry entry_x1802sub0 = ObjectEntry(&data.x1802.sub0, 1, 1);
    ObjectEntry entry_x1802sub1 = ObjectEntry(&data.x1802.sub1, 3, 4);
    ObjectEntry entry_x1802sub2 = ObjectEntry(&data.x1802.sub2, 3, 1);
    ObjectEntry entry_x1802sub3 = ObjectEntry(&data.x1802.sub3, 3, 2);
    ObjectEntry entry_x1802sub4 = ObjectEntry(&data.x1802.sub4, 3, 1);
    ObjectEntry entry_x1802sub5 = ObjectEntry(&data.x1802.sub5, 3, 2);
    ObjectEntry entry_x1802sub6 = ObjectEntry(&data.x1802.sub6, 3, 1);
    ...
    ObjectEntry entry_x1803sub0 = ObjectEntry(&data.x1803.sub0, 1, 1);
    ObjectEntry entry_x1803sub1 = ObjectEntry(&data.x1803.sub1, 3, 4);
    ObjectEntry entry_x1803sub2 = ObjectEntry(&data.x1803.sub2, 3, 1);
    ObjectEntry entry_x1803sub3 = ObjectEntry(&data.x1803.sub3, 3, 2);
    ObjectEntry entry_x1803sub4 = ObjectEntry(&data.x1803.sub4, 3, 1);
    ObjectEntry entry_x1803sub5 = ObjectEntry(&data.x1803.sub5, 3, 2);
    ObjectEntry entry_x1803sub6 = ObjectEntry(&data.x1803.sub6, 3, 1);
    ...
    ObjectEntry entry_x1A00sub0 = ObjectEntry(&data.x1A00.sub0, 3, 1);
    ObjectEntry entry_x1A00sub1 = ObjectEntry(&data.x1A00.sub1, 3, 4);
    ObjectEntry entry_x1A00sub2 = ObjectEntry(&data.x1A00.sub2, 3, 4);
    ObjectEntry entry_x1A00sub3 = ObjectEntry(&data.x1A00.sub3, 3, 4);
    ObjectEntry entry_x1A00sub4 = ObjectEntry(&data.x1A00.sub4, 3, 4);
    ObjectEntry entry_x1A00sub5 = ObjectEntry(&data.x1A00.sub5, 3, 4);
    ObjectEntry entry_x1A00sub6 = ObjectEntry(&data.x1A00.sub6, 3, 4);
    ObjectEntry entry_x1A00sub7 = ObjectEntry(&data.x1A00.sub7, 3, 4);
    ObjectEntry entry_x1A00sub8 = ObjectEntry(&data.x1A00.sub8, 3, 4);
    ...
    ObjectEntry entry_x1A01sub0 = ObjectEntry(&data.x1A01.sub0, 3, 1);
    ObjectEntry entry_x1A01sub1 = ObjectEntry(&data.x1A01.sub1, 3, 4);
    ObjectEntry entry_x1A01sub2 = ObjectEntry(&data.x1A01.sub2, 3, 4);
    ObjectEntry entry_x1A01sub3 = ObjectEntry(&data.x1A01.sub3, 3, 4);
    ObjectEntry entry_x1A01sub4 = ObjectEntry(&data.x1A01.sub4, 3, 4);
    ObjectEntry entry_x1A01sub5 = ObjectEntry(&data.x1A01.sub5, 3, 4);
    ObjectEntry entry_x1A01sub6 = ObjectEntry(&data.x1A01.sub6, 3, 4);
    ObjectEntry entry_x1A01sub7 = ObjectEntry(&data.x1A01.sub7, 3, 4);
    ObjectEntry entry_x1A01sub8 = ObjectEntry(&data.x1A01.sub8, 3, 4);
    ...
    ObjectEntry entry_x1A02sub0 = ObjectEntry(&data.x1A02.sub0, 3, 1);
    ObjectEntry entry_x1A02sub1 = ObjectEntry(&data.x1A02.sub1, 3, 4);
    ObjectEntry entry_x1A02sub2 = ObjectEntry(&data.x1A02.sub2, 3, 4);
    ObjectEntry entry_x1A02sub3 = ObjectEntry(&data.x1A02.sub3, 3, 4);
    ObjectEntry entry_x1A02sub4 = ObjectEntry(&data.x1A02.sub4, 3, 4);
    ObjectEntry entry_x1A02sub5 = ObjectEntry(&data.x1A02.sub5, 3, 4);
    ObjectEntry entry_x1A02sub6 = ObjectEntry(&data.x1A02.sub6, 3, 4);
    ObjectEntry entry_x1A02sub7 = ObjectEntry(&data.x1A02.sub7, 3, 4);
    ObjectEntry entry_x1A02sub8 = ObjectEntry(&data.x1A02.sub8, 3, 4);
    ...
    ObjectEntry entry_x1A03sub0 = ObjectEntry(&data.x1A03.sub0, 3, 1);
    ObjectEntry entry_x1A03sub1 = ObjectEntry(&data.x1A03.sub1, 3, 4);
    ObjectEntry entry_x1A03sub2 = ObjectEntry(&data.x1A03.sub2, 3, 4);
    ObjectEntry entry_x1A03sub3 = ObjectEntry(&data.x1A03.sub3, 3, 4);
    ObjectEntry entry_x1A03sub4 = ObjectEntry(&data.x1A03.sub4, 3, 4);
    ObjectEntry entry_x1A03sub5 = ObjectEntry(&data.x1A03.sub5, 3, 4);
    ObjectEntry entry_x1A03sub6 = ObjectEntry(&data.x1A03.sub6, 3, 4);
    ObjectEntry entry_x1A03sub7 = ObjectEntry(&data.x1A03.sub7, 3, 4);
    ObjectEntry entry_x1A03sub8 = ObjectEntry(&data.x1A03.sub8, 3, 4);
    ...
    ObjectEntry entry_x1F51sub0 = ObjectEntry(&data.x1F51, 3, 974);
    ObjectEntryBase *entries_x1F51[1] = {&entry_x1F51sub0};
    ObjectEntry entry_x1F57sub0 = ObjectEntry(&data.x1F57sub0, 1, 1);
    ObjectEntry entry_x1F57sub1 = ObjectEntry(&data.x1F57[0], 1, 4);
    ObjectEntry entry_x1F57sub2 = ObjectEntry(&data.x1F57[1], 1, 4);
    ObjectEntryBase *entries_x1F57[3] = {&entry_x1F57sub0, &entry_x1F57sub1, &entry_x1F57sub2};
    ObjectEntry entry_x1F80sub0 = ObjectEntry(&data.x1F80, 3, 4);
    ObjectEntryBase *entries_x1F80[1] = {&entry_x1F80sub0};
    ObjectEntry entry_x6007sub0 = ObjectEntry(&data.x6007, 3, 2);
    ObjectEntryBase *entries_x6007[1] = {&entry_x6007sub0};
    ObjectEntry entry_x603Fsub0 = ObjectEntry(&data.x603F, 5, 2);
    ObjectEntryBase *entries_x603F[1] = {&entry_x603Fsub0};
    ObjectEntry entry_x6040sub0 = ObjectEntry(&data.x6040, 7, 2);
    ObjectEntryBase *entries_x6040[1] = {&entry_x6040sub0};
    ObjectEntry entry_x6041sub0 = ObjectEntry(&data.x6041, 5, 2);
    ObjectEntryBase *entries_x6041[1] = {&entry_x6041sub0};
    ObjectEntry entry_x6042sub0 = ObjectEntry(&data.x6042, 7, 2);
    ObjectEntryBase *entries_x6042[1] = {&entry_x6042sub0};
    ObjectEntry entry_x6043sub0 = ObjectEntry(&data.x6043, 5, 2);
    ObjectEntryBase *entries_x6043[1] = {&entry_x6043sub0};
    ObjectEntry entry_x6044sub0 = ObjectEntry(&data.x6044, 5, 2);
    ObjectEntryBase *entries_x6044[1] = {&entry_x6044sub0};
    ObjectEntry entry_x6046sub0 = ObjectEntry(&data.x6046sub0, 1, 1);
    ObjectEntry entry_x6046sub1 = ObjectEntry(&data.x6046[0], 7, 4);
    ObjectEntry entry_x6046sub2 = ObjectEntry(&data.x6046[1], 7, 4);
    ObjectEntryBase *entries_x6046[3] = {&entry_x6046sub0, &entry_x6046sub1, &entry_x6046sub2};
    ObjectEntry entry_x6048sub0 = ObjectEntry(&data.x6048.sub0, 1, 1);
    ObjectEntry entry_x6048sub1 = ObjectEntry(&data.x6048.sub1, 7, 8);
    ObjectEntry entry_x6048sub2 = ObjectEntry(&data.x6048.sub2, 7, 4);
    ObjectEntryBase *entries_x6048[3] = {&entry_x6048sub0, &entry_x6048sub1, &entry_x6048sub2};
    ObjectEntry entry_x6049sub0 = ObjectEntry(&data.x6049.sub0, 1, 1);
    ObjectEntry entry_x6049sub1 = ObjectEntry(&data.x6049.sub1, 5, 4);
    ObjectEntry entry_x6049sub2 = ObjectEntry(&data.x6049.sub2, 6, 2);
    ObjectEntryBase *entries_x6049[3] = {&entry_x6049sub0, &entry_x6049sub1, &entry_x6049sub2};
    ObjectEntry entry_x604Asub0 = ObjectEntry(&data.x604A.sub0, 1, 1);
    ObjectEntry entry_x604Asub1 = ObjectEntry(&data.x604A.sub1, 7, 8);
    ObjectEntry entry_x604Asub2 = ObjectEntry(&data.x604A.sub2, 7, 8);
    ObjectEntryBase *entries_x604A[3] = {&entry_x604Asub0, &entry_x604Asub1, &entry_x604Asub2};
    ObjectEntry entry_x6060sub0 = ObjectEntry(&data.x6060, 7, 1);
    ObjectEntryBase *entries_x6060[1] = {&entry_x6060sub0};
    ObjectEntry entry_x6061sub0 = ObjectEntry(&data.x6061, 5, 1);
    ObjectEntryBase *entries_x6061[1] = {&entry_x6061sub0};
    ObjectEntry entry_x6064sub0 = ObjectEntry(&data.x6064, 5, 4);
    ...
    ObjectEntry entry_x6081sub0 = ObjectEntry(&data.x6081, 7, 4);
    ObjectEntryBase *entries_x6081[1] = {&entry_x6081sub0};
    ObjectEntry entry_x60FDsub0 = ObjectEntry(&data.x60FD, 5, 4);
    ObjectEntryBase *entries_x60FD[1] = {&entry_x60FDsub0};
    ObjectEntry entry_x60FEsub0 = ObjectEntry(&data.x60FEsub0, 1, 1);
    ObjectEntry entry_x60FEsub1 = ObjectEntry(&data.x60FE[0], 7, 4);
