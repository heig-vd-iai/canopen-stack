...
SDOAbortCodes Object1800::preReadBytes(uint8_t subindex, uint8_t * /*bytes*/, uint32_t /*sizeBytes*/, uint32_t /*offset*/)
{
...
SDOAbortCodes Object1800::preWriteBytes(uint8_t subindex, uint8_t *bytes, uint32_t /*sizeBytes*/, Node & /*node*/)
{
...
void Object1800::postWriteBytes(uint8_t /*subindex*/, uint8_t * /*bytes*/, uint32_t /*sizeBytes*/, Node &node)
{
    if (remap)
    {
        node.pdo().reloadTPDO();
