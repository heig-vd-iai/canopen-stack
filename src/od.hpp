...
namespace CANopen
{
    ...
    private:
        struct 
        {
            ...
            Object x1003 = Object(4099, 9, 8, entries.x1003);
            ...
            TPDOCommunicationObject x1800 = TPDOCommunicationObject(6144, 7, 8, entries.x1800);
            TPDOCommunicationObject x1801 = TPDOCommunicationObject(6145, 7, 8, entries.x1801);
            TPDOCommunicationObject x1802 = TPDOCommunicationObject(6146, 7, 8, entries.x1802);
            TPDOCommunicationObject x1803 = TPDOCommunicationObject(6147, 7, 8, entries.x1803);
            TPDOMappingObject x1A00 = TPDOMappingObject(6656, 9, 8, entries.x1A00);
            TPDOMappingObject x1A01 = TPDOMappingObject(6657, 9, 8, entries.x1A01);
            TPDOMappingObject x1A02 = TPDOMappingObject(6658, 9, 8, entries.x1A02);
            TPDOMappingObject x1A03 = TPDOMappingObject(6659, 9, 8, entries.x1A03);
