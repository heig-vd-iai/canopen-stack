...
struct OD_Objects // Struct containing all of the dictionnary objects
{
    ...
    OD_Objects(OD_Data &data) : obj_x2{OD_Object(5, 2, &data.x2)}, obj_x3{OD_Object(5, 3, &data.x3)}, obj_x4{OD_Object(5, 4, &data.x4)}, obj_x5{OD_Object(5, 5, &data.x5)}, obj_x6{OD_Object(5, 6, &data.x6)}, obj_x7{OD_Object(5, 7, &data.x7)}, obj_x1000{OD_Object(1, 7, &data.x1000)}, obj_x1001{OD_Object(1, 5, &data.x1001)}, obj_x1003{OD_Object(3, 5, &data.x1003sub0), OD_Object(1, 7, &data.x1003[0]), OD_Object(1, 7, &data.x1003[1]), OD_Object(1, 7, &data.x1003[2]), OD_Object(1, 7, &data.x1003[3]), OD_Object(1, 7, &data.x1003[4]), OD_Object(1, 7, &data.x1003[5]), OD_Object(1, 7, &data.x1003[6]), OD_Object(1, 7, &data.x1003[7])}, obj_x1005{OD_Object(3, 7, &data.x1005)}, obj_x1006{OD_Object(3, 7, &data.x1006)}, obj_x1007{OD_Object(3, 7, &data.x1007)}, obj_x100C{OD_Object(3, 6, &data.x100C)}, obj_x100D{OD_Object(3, 5, &data.x100D)}, obj_x1010{OD_Object(1, 5, &data.x1010sub0), OD_Object(3, 7, &data.x1010[0]), OD_Object(3, 7, &data.x1010[1]), OD_Object(3, 7, &data.x1010[2]), OD_Object(3, 7, &data.x1010[3]), OD_Object(3, 7, &data.x1010[4]), OD_Object(3, 7, &data.x1010[5]), OD_Object(3, 7, &data.x1010[6]), OD_Object(3, 7, &data.x1010[7]), OD_Object(3, 7, &data.x1010[8]), OD_Object(3, 7, &data.x1010[9]), OD_Object(3, 7, &data.x1010[10]), OD_Object(3, 7, &data.x1010[11]), OD_Object(3, 7, &data.x1010[12])}, obj_x1011{OD_Object(1, 5, &data.x1011sub0), OD_Object(3, 7, &data.x1011[0]), OD_Object(3, 7, &data.x1011[1]), OD_Object(3, 7, &data.x1011[2]), OD_Object(3, 7, &data.x1011[3]), OD_Object(3, 7, &data.x1011[4]), OD_Object(3, 7, &data.x1011[5]), OD_Object(3, 7, &data.x1011[6]), OD_Object(3, 7, &data.x1011[7]), OD_Object(3, 7, &data.x1011[8]), OD_Object(3, 7, &data.x1011[9]), OD_Object(3, 7, &data.x1011[10]), OD_Object(3, 7, &data.x1011[11]), OD_Object(3, 7, &data.x1011[12])}, obj_x1014{OD_Object(3, 7, &data.x1014)}, obj_x1016{OD_Object(1, 5, &data.x1016sub0), OD_Object(3, 7, &data.x1016[0])}, obj_x1017{OD_Object(3, 6, &data.x1017)}, obj_x1018{OD_Object(1, 5, &data.x1018.sub0), OD_Object(1, 7, &data.x1018.sub1), OD_Object(1, 7, &data.x1018.sub2), OD_Object(1, 7, &data.x1018.sub3), OD_Object(1, 7, &data.x1018.sub4)}, obj_x1019{OD_Object(3, 5, &data.x1019)}, obj_x1020{OD_Object(1, 5, &data.x1020sub0), OD_Object(3, 7, &data.x1020[0]), OD_Object(3, 7, &data.x1020[1])}, obj_x1029{OD_Object(1, 5, &data.x1029sub0), OD_Object(3, 5, &data.x1029[0]), OD_Object(3, 5, &data.x1029[1])}, obj_x1400{OD_Object(1, 5, &data.x1400.sub0), OD_Object(3, 7, &data.x1400.sub1), OD_Object(3, 5, &data.x1400.sub2)}, obj_x1401{OD_Object(1, 5, &data.x1401.sub0), OD_Object(3, 7, &data.x1401.sub1), OD_Object(3, 5, &data.x1401.sub2)}, obj_x1402{OD_Object(1, 5, &data.x1402.sub0), OD_Object(3, 7, &data.x1402.sub1), OD_Object(3, 5, &data.x1402.sub2)}, obj_x1403{OD_Object(1, 5, &data.x1403.sub0), OD_Object(3, 7, &data.x1403.sub1), OD_Object(3, 5, &data.x1403.sub2)}, obj_x1404{OD_Object(1, 5, &data.x1404.sub0), OD_Object(3, 7, &data.x1404.sub1), OD_Object(3, 5, &data.x1404.sub2)}, obj_x1405{OD_Object(1, 5, &data.x1405.sub0), OD_Object(3, 7, &data.x1405.sub1), OD_Object(3, 5, &data.x1405.sub2)}, obj_x1406{OD_Object(1, 5, &data.x1406.sub0), OD_Object(3, 7, &data.x1406.sub1), OD_Object(3, 5, &data.x1406.sub2)}, obj_x1407{OD_Object(1, 5, &data.x1407.sub0), OD_Object(3, 7, &data.x1407.sub1), OD_Object(3, 5, &data.x1407.sub2)}, obj_x1600{OD_Object(3, 5, &data.x1600.sub0), OD_Object(3, 7, &data.x1600.sub1), OD_Object(3, 7, &data.x1600.sub2), OD_Object(3, 7, &data.x1600.sub3), OD_Object(3, 7, &data.x1600.sub4), OD_Object(3, 7, &data.x1600.sub5), OD_Object(3, 7, &data.x1600.sub6), OD_Object(3, 7, &data.x1600.sub7), OD_Object(3, 7, &data.x1600.sub8)}, obj_x1601{OD_Object(3, 5, &data.x1601.sub0), OD_Object(3, 7, &data.x1601.sub1), OD_Object(3, 7, &data.x1601.sub2), OD_Object(3, 7, &data.x1601.sub3), OD_Object(3, 7, &data.x1601.sub4), OD_Object(3, 7, &data.x1601.sub5), OD_Object(3, 7, &data.x1601.sub6), OD_Object(3, 7, &data.x1601.sub7), OD_Object(3, 7, &data.x1601.sub8)}, obj_x1602{OD_Object(3, 5, &data.x1602.sub0), OD_Object(3, 7, &data.x1602.sub1), OD_Object(3, 7, &data.x1602.sub2), OD_Object(3, 7, &data.x1602.sub3), OD_Object(3, 7, &data.x1602.sub4), OD_Object(3, 7, &data.x1602.sub5), OD_Object(3, 7, &data.x1602.sub6), OD_Object(3, 7, &data.x1602.sub7), OD_Object(3, 7, &data.x1602.sub8)}, obj_x1603{OD_Object(3, 5, &data.x1603.sub0), OD_Object(3, 7, &data.x1603.sub1), OD_Object(3, 7, &data.x1603.sub2), OD_Object(3, 7, &data.x1603.sub3), OD_Object(3, 7, &data.x1603.sub4), OD_Object(3, 7, &data.x1603.sub5), OD_Object(3, 7, &data.x1603.sub6), OD_Object(3, 7, &data.x1603.sub7), OD_Object(3, 7, &data.x1603.sub8)}, obj_x1604{OD_Object(3, 5, &data.x1604.sub0), OD_Object(3, 7, &data.x1604.sub1), OD_Object(3, 7, &data.x1604.sub2), OD_Object(3, 7, &data.x1604.sub3), OD_Object(3, 7, &data.x1604.sub4), OD_Object(3, 7, &data.x1604.sub5), OD_Object(3, 7, &data.x1604.sub6), OD_Object(3, 7, &data.x1604.sub7), OD_Object(3, 7, &data.x1604.sub8)}, obj_x1605{OD_Object(3, 5, &data.x1605.sub0), OD_Object(3, 7, &data.x1605.sub1), OD_Object(3, 7, &data.x1605.sub2), OD_Object(3, 7, &data.x1605.sub3), OD_Object(3, 7, &data.x1605.sub4), OD_Object(3, 7, &data.x1605.sub5), OD_Object(3, 7, &data.x1605.sub6), OD_Object(3, 7, &data.x1605.sub7), OD_Object(3, 7, &data.x1605.sub8)}, obj_x1606{OD_Object(3, 5, &data.x1606.sub0), OD_Object(3, 7, &data.x1606.sub1), OD_Object(3, 7, &data.x1606.sub2), OD_Object(3, 7, &data.x1606.sub3), OD_Object(3, 7, &data.x1606.sub4), OD_Object(3, 7, &data.x1606.sub5), OD_Object(3, 7, &data.x1606.sub6), OD_Object(3, 7, &data.x1606.sub7), OD_Object(3, 7, &data.x1606.sub8)}, obj_x1607{OD_Object(3, 5, &data.x1607.sub0), OD_Object(3, 7, &data.x1607.sub1), OD_Object(3, 7, &data.x1607.sub2), OD_Object(3, 7, &data.x1607.sub3), OD_Object(3, 7, &data.x1607.sub4), OD_Object(3, 7, &data.x1607.sub5), OD_Object(3, 7, &data.x1607.sub6), OD_Object(3, 7, &data.x1607.sub7), OD_Object(3, 7, &data.x1607.sub8)}, obj_x1800{OD_Object(1, 5, &data.x1800.sub0), OD_Object(3, 7, &data.x1800.sub1), OD_Object(3, 5, &data.x1800.sub2), OD_Object(3, 6, &data.x1800.sub3), OD_Object(3, 5, &data.x1800.sub4), OD_Object(3, 6, &data.x1800.sub5), OD_Object(3, 5, &data.x1800.sub6)}, obj_x1801{OD_Object(1, 5, &data.x1801.sub0), OD_Object(3, 7, &data.x1801.sub1), OD_Object(3, 5, &data.x1801.sub2), OD_Object(3, 6, &data.x1801.sub3), OD_Object(3, 5, &data.x1801.sub4), OD_Object(3, 6, &data.x1801.sub5), OD_Object(3, 5, &data.x1801.sub6)}, obj_x1802{OD_Object(1, 5, &data.x1802.sub0), OD_Object(3, 7, &data.x1802.sub1), OD_Object(3, 5, &data.x1802.sub2), OD_Object(3, 6, &data.x1802.sub3), OD_Object(3, 5, &data.x1802.sub4), OD_Object(3, 6, &data.x1802.sub5), OD_Object(3, 5, &data.x1802.sub6)}, obj_x1803{OD_Object(1, 5, &data.x1803.sub0), OD_Object(3, 7, &data.x1803.sub1), OD_Object(3, 5, &data.x1803.sub2), OD_Object(3, 6, &data.x1803.sub3), OD_Object(3, 5, &data.x1803.sub4), OD_Object(3, 6, &data.x1803.sub5), OD_Object(3, 5, &data.x1803.sub6)}, obj_x1804{OD_Object(1, 5, &data.x1804.sub0), OD_Object(3, 7, &data.x1804.sub1), OD_Object(3, 5, &data.x1804.sub2), OD_Object(3, 6, &data.x1804.sub3), OD_Object(3, 5, &data.x1804.sub4), OD_Object(3, 6, &data.x1804.sub5), OD_Object(3, 5, &data.x1804.sub6)}, obj_x1805{OD_Object(1, 5, &data.x1805.sub0), OD_Object(3, 7, &data.x1805.sub1), OD_Object(3, 5, &data.x1805.sub2), OD_Object(3, 6, &data.x1805.sub3), OD_Object(3, 5, &data.x1805.sub4), OD_Object(3, 6, &data.x1805.sub5), OD_Object(3, 5, &data.x1805.sub6)}, obj_x1806{OD_Object(1, 5, &data.x1806.sub0), OD_Object(3, 7, &data.x1806.sub1), OD_Object(3, 5, &data.x1806.sub2), OD_Object(3, 6, &data.x1806.sub3), OD_Object(3, 5, &data.x1806.sub4), OD_Object(3, 6, &data.x1806.sub5), OD_Object(3, 5, &data.x1806.sub6)}, obj_x1807{OD_Object(1, 5, &data.x1807.sub0), OD_Object(3, 7, &data.x1807.sub1), OD_Object(3, 5, &data.x1807.sub2), OD_Object(3, 6, &data.x1807.sub3), OD_Object(3, 5, &data.x1807.sub4), OD_Object(3, 6, &data.x1807.sub5), OD_Object(3, 5, &data.x1807.sub6)}, obj_x1A00{OD_Object(3, 5, &data.x1A00.sub0), OD_Object(3, 7, &data.x1A00.sub1), OD_Object(3, 7, &data.x1A00.sub2), OD_Object(3, 7, &data.x1A00.sub3), OD_Object(3, 7, &data.x1A00.sub4), OD_Object(3, 7, &data.x1A00.sub5), OD_Object(3, 7, &data.x1A00.sub6), OD_Object(3, 7, &data.x1A00.sub7), OD_Object(3, 7, &data.x1A00.sub8)}, obj_x1A01{OD_Object(3, 5, &data.x1A01.sub0), OD_Object(3, 7, &data.x1A01.sub1), OD_Object(3, 7, &data.x1A01.sub2), OD_Object(3, 7, &data.x1A01.sub3), OD_Object(3, 7, &data.x1A01.sub4), OD_Object(3, 7, &data.x1A01.sub5), OD_Object(3, 7, &data.x1A01.sub6), OD_Object(3, 7, &data.x1A01.sub7), OD_Object(3, 7, &data.x1A01.sub8)}, obj_x1A02{OD_Object(3, 5, &data.x1A02.sub0), OD_Object(3, 7, &data.x1A02.sub1), OD_Object(3, 7, &data.x1A02.sub2), OD_Object(3, 7, &data.x1A02.sub3), OD_Object(3, 7, &data.x1A02.sub4), OD_Object(3, 7, &data.x1A02.sub5), OD_Object(3, 7, &data.x1A02.sub6), OD_Object(3, 7, &data.x1A02.sub7), OD_Object(3, 7, &data.x1A02.sub8)}, obj_x1A03{OD_Object(3, 5, &data.x1A03.sub0), OD_Object(3, 7, &data.x1A03.sub1), OD_Object(3, 7, &data.x1A03.sub2), OD_Object(3, 7, &data.x1A03.sub3), OD_Object(3, 7, &data.x1A03.sub4), OD_Object(3, 7, &data.x1A03.sub5), OD_Object(3, 7, &data.x1A03.sub6), OD_Object(3, 7, &data.x1A03.sub7), OD_Object(3, 7, &data.x1A03.sub8)}, obj_x1A04{OD_Object(3, 5, &data.x1A04.sub0), OD_Object(3, 7, &data.x1A04.sub1), OD_Object(3, 7, &data.x1A04.sub2), OD_Object(3, 7, &data.x1A04.sub3), OD_Object(3, 7, &data.x1A04.sub4), OD_Object(3, 7, &data.x1A04.sub5), OD_Object(3, 7, &data.x1A04.sub6), OD_Object(3, 7, &data.x1A04.sub7), OD_Object(3, 7, &data.x1A04.sub8)}, obj_x1A05{OD_Object(3, 5, &data.x1A05.sub0), OD_Object(3, 7, &data.x1A05.sub1), OD_Object(3, 7, &data.x1A05.sub2), OD_Object(3, 7, &data.x1A05.sub3), OD_Object(3, 7, &data.x1A05.sub4), OD_Object(3, 7, &data.x1A05.sub5), OD_Object(3, 7, &data.x1A05.sub6), OD_Object(3, 7, &data.x1A05.sub7), OD_Object(3, 7, &data.x1A05.sub8)}, obj_x1A06{OD_Object(3, 5, &data.x1A06.sub0), OD_Object(3, 7, &data.x1A06.sub1), OD_Object(3, 7, &data.x1A06.sub2), OD_Object(3, 7, &data.x1A06.sub3), OD_Object(3, 7, &data.x1A06.sub4), OD_Object(3, 7, &data.x1A06.sub5), OD_Object(3, 7, &data.x1A06.sub6), OD_Object(3, 7, &data.x1A06.sub7), OD_Object(3, 7, &data.x1A06.sub8)}, obj_x1A07{OD_Object(3, 5, &data.x1A07.sub0), OD_Object(3, 7, &data.x1A07.sub1), OD_Object(3, 7, &data.x1A07.sub2), OD_Object(3, 7, &data.x1A07.sub3), OD_Object(3, 7, &data.x1A07.sub4), OD_Object(3, 7, &data.x1A07.sub5), OD_Object(3, 7, &data.x1A07.sub6), OD_Object(3, 7, &data.x1A07.sub7), OD_Object(3, 7, &data.x1A07.sub8)}, obj_x1F51{OD_Object(1, 5, &data.x1F51sub0), OD_Object(3, 5, &data.x1F51[0]), OD_Object(3, 5, &data.x1F51[1])}, obj_x1F57{OD_Object(1, 5, &data.x1F57sub0), OD_Object(1, 7, &data.x1F57[0]), OD_Object(1, 7, &data.x1F57[1])}, obj_x1F80{OD_Object(3, 7, &data.x1F80)}, obj_x6007{OD_Object(3, 3, &data.x6007)}, obj_x603F{OD_Object(1, 6, &data.x603F)}, obj_x6040{OD_Object(3, 6, &data.x6040)}, obj_x6041{OD_Object(1, 6, &data.x6041)}, obj_x6042{OD_Object(3, 3, &data.x6042)}, obj_x6043{OD_Object(1, 3, &data.x6043)}, obj_x6044{OD_Object(1, 3, &data.x6044)}, obj_x6046{OD_Object(5, 5, &data.x6046sub0), OD_Object(3, 7, &data.x6046[0]), OD_Object(3, 7, &data.x6046[1])}, obj_x6048{OD_Object(5, 5, &data.x6048.sub0), OD_Object(3, 17, &data.x6048.sub1), OD_Object(3, 8, &data.x6048.sub2)}, obj_x6049{OD_Object(5, 5, &data.x6049.sub0), OD_Object(1, 7, &data.x6049.sub1), OD_Object(2, 6, &data.x6049.sub2)}, obj_x604A{OD_Object(5, 5, &data.x604A.sub0), OD_Object(3, 27, &data.x604A.sub1), OD_Object(3, 27, &data.x604A.sub2)}{}
};
