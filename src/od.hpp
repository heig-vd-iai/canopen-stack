    ...
    private:
        ...
        struct 
        {
            struct
            {
                ...
                ObjectEntry x1001[1] = {ObjectEntry(&data.x1001, 1, 1)};
                ...
                ObjectEntry x1F51[3] = {ObjectEntry(&data.x1F51sub0, 1, 1), ObjectEntry(&data.x1F51[0], 3, 1), ObjectEntry(&data.x1F51[1], 3, 1)};
                ...
                ObjectEntry x603F[1] = {ObjectEntry(&data.x603F, 1, 2)};
                ObjectEntry x6040[1] = {ObjectEntry(&data.x6040, 3, 2)};
                ObjectEntry x6041[1] = {ObjectEntry(&data.x6041, 1, 2)};
                ObjectEntry x6042[1] = {ObjectEntry(&data.x6042, 3, 2)};
                ObjectEntry x6043[1] = {ObjectEntry(&data.x6043, 1, 2)};
                ObjectEntry x6044[1] = {ObjectEntry(&data.x6044, 1, 2)};
                ObjectEntry x6046[3] = {ObjectEntry(&data.x6046sub0, 1, 1), ObjectEntry(&data.x6046[0], 3, 4), ObjectEntry(&data.x6046[1], 3, 4)};
                ObjectEntry x6048[3] = {ObjectEntry(&data.x6048.sub0, 1, 1), ObjectEntry(&data.x6048.sub1, 3, 8), ObjectEntry(&data.x6048.sub2, 3, 4)};
                ObjectEntry x6049[3] = {ObjectEntry(&data.x6049.sub0, 1, 1), ObjectEntry(&data.x6049.sub1, 1, 4), ObjectEntry(&data.x6049.sub2, 2, 2)};
                ObjectEntry x604A[3] = {ObjectEntry(&data.x604A.sub0, 1, 1), ObjectEntry(&data.x604A.sub1, 3, 8), ObjectEntry(&data.x604A.sub2, 3, 8)};
                ObjectEntry x6060[1] = {ObjectEntry(&data.x6060, 3, 1)};
                ObjectEntry x6061[1] = {ObjectEntry(&data.x6061, 1, 1)};
                ObjectEntry x6064[1] = {ObjectEntry(&data.x6064, 1, 4)};
                ObjectEntry x607A[1] = {ObjectEntry(&data.x607A, 3, 4)};
                ObjectEntry x6081[1] = {ObjectEntry(&data.x6081, 3, 4)};
                ObjectEntry x60FD[1] = {ObjectEntry(&data.x60FD, 1, 4)};
                ObjectEntry x60FE[2] = {ObjectEntry(&data.x60FEsub0, 1, 1), ObjectEntry(&data.x60FE[0], 3, 4)};
            } entries;
