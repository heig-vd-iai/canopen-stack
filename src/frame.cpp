...
SDOFrameBase::SDOFrameBase(uint8_t nodeId, uint8_t commandByte)
    : Frame(nodeId, FunctionCode_TSDO) {
    dlc = SDO_DLC;
...
uint8_t SDOFrameBase::getSubindex() const { return data[SDO_SUBINDEX_OFFSET]; }
...
SDOFrame::SDOFrame(uint8_t nodeId, uint8_t commandByte)
    : SDOFrameBase(nodeId, commandByte) {}
...
SDOBlockFrame::SDOBlockFrame(uint8_t nodeId, uint8_t commandByte)
    : SDOFrameBase(nodeId, commandByte) {}
...
uint8_t SDOBlockFrame::getPST() const { return data[SDO_BLOCK_PST_OFFSET]; }
